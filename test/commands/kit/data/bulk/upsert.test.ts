...
describe(commandName, () => {
  ...
  const parseCsv = jest.spyOn(Command.prototype, 'parseCsv').mockReturnValue(Promise.resolve(csvRows));
  ...
  jest.spyOn(Command.prototype, 'loadScript').mockReturnValue({ convert, start, finish });
  testSetup
